...
var G__42165 = clojure.zip.node(loc);
var fexpr__42164 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
...
var G__42167 = clojure.zip.node(loc);
var fexpr__42166 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__42166.cljs$core$IFn$_invoke$arity$1 ? fexpr__42166.cljs$core$IFn$_invoke$arity$1(G__42167) : fexpr__42166.call(null,G__42167));
} else {
...
var fexpr__42168 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__42168.cljs$core$IFn$_invoke$arity$2 ? fexpr__42168.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__42168.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__42178 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42178,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42178,(1),null);
var vec__42181 = clojure.zip.children(loc);
var seq__42182 = cljs.core.seq(vec__42181);
var first__42183 = cljs.core.first(seq__42182);
var seq__42182__$1 = cljs.core.next(seq__42182);
var c = first__42183;
var cnext = seq__42182__$1;
var cs = vec__42181;
...
var vec__42188 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42188,(0),null);
var map__42191 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42188,(1),null);
...
var path = map__42191__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42191__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42191__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42191__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42191__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42191__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__42197 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42197,(0),null);
var map__42200 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42197,(1),null);
...
var path = map__42200__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42200__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__42201 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42200__$1,new cljs.core.Keyword(null,"r","r",-471384190));
...
var vec__42207 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42207,(0),null);
var map__42210 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42207,(1),null);
...
var path = map__42210__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42210__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42210__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4120__auto__ = path;
if(cljs.core.truth_(and__4120__auto__)){
return r;
} else {
...
var vec__42213 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42213,(0),null);
var map__42216 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42213,(1),null);
...
var path = map__42216__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42216__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42216__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4120__auto__ = path;
if(cljs.core.truth_(and__4120__auto__)){
...
var vec__42218 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42218,(0),null);
var map__42221 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42218,(1),null);
var map__42221__$1 = (((((!((map__42221 == null))))?(((((map__42221.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42221.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__42221):map__42221);
var path = map__42221__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42221__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42221__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4120__auto__ = path;
if(cljs.core.truth_(and__4120__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__42229 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42229,(0),null);
var map__42232 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42229,(1),null);
var map__42232__$1 = (((((!((map__42232 == null))))?(((((map__42232.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42232.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__42232):map__42232);
var path = map__42232__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42232__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__42234 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42234,(0),null);
var map__42237 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42234,(1),null);
...
var path = map__42237__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42237__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__42239 = loc;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42239,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42239,(1),null);
...
var len__4730__auto___42272 = arguments.length;
var i__4731__auto___42273 = (0);
while(true){
if((i__4731__auto___42273 < len__4730__auto___42272)){
args__4736__auto__.push((arguments[i__4731__auto___42273]));

var G__42274 = (i__4731__auto___42273 + (1));
i__4731__auto___42273 = G__42274;
continue;
} else {
}
break;
...
/** @this {Function} */
clojure.zip.edit.cljs$lang$applyTo = (function (seq42242){
var G__42243 = cljs.core.first(seq42242);
var seq42242__$1 = cljs.core.next(seq42242);
var G__42244 = cljs.core.first(seq42242__$1);
var seq42242__$2 = cljs.core.next(seq42242__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42243,G__42244,seq42242__$2);
});
...
var G__42290 = clojure.zip.rightmost(child);
loc__$1 = G__42290;
continue;
} else {
return loc__$1;
...
var vec__42245 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42245,(0),null);
var map__42248 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42245,(1),null);
var map__42248__$1 = (((((!((map__42248 == null))))?(((((map__42248.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42248.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__42248):map__42248);
var path = map__42248__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42248__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42248__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42248__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42248__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__42291 = clojure.zip.rightmost(child);
loc__$1 = G__42291;
continue;
} else {
return loc__$1;
