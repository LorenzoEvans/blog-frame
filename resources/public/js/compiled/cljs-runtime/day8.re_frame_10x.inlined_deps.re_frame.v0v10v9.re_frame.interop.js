...
day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.interop.empty_queue = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentQueue.EMPTY,cljs.core.PersistentVector.EMPTY);
...
return day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.core.atom.cljs$core$IFn$_invoke$arity$1(x);
});
...
return cljs.core.native_satisfies_QMARK_(day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.IReactiveAtom,x);
} else {
return false;
}
}
...
return day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.make_reaction(f);
});
...
return day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.add_on_dispose_BANG_(a_ratom,f);
});
...
return day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.dispose_BANG_(a_ratom);
});
...
return [(function (){var pred__40277 = cljs.core.instance_QMARK_;
var expr__40278 = reactive_val;
if(cljs.core.truth_((pred__40277.cljs$core$IFn$_invoke$arity$2 ? pred__40277.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.RAtom,expr__40278) : pred__40277.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.RAtom,expr__40278)))){
return "ra";
} else {
if(cljs.core.truth_((pred__40277.cljs$core$IFn$_invoke$arity$2 ? pred__40277.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.RCursor,expr__40278) : pred__40277.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.RCursor,expr__40278)))){
return "rc";
} else {
if(cljs.core.truth_((pred__40277.cljs$core$IFn$_invoke$arity$2 ? pred__40277.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.Reaction,expr__40278) : pred__40277.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.Reaction,expr__40278)))){
return "rx";
} else {
if(cljs.core.truth_((pred__40277.cljs$core$IFn$_invoke$arity$2 ? pred__40277.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.Track,expr__40278) : pred__40277.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v8v1.reagent.ratom.Track,expr__40278)))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.interop.js.map
