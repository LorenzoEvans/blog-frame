...
var i__4731__auto___40281 = (0);
while(true){
if((i__4731__auto___40281 < len__4730__auto___40280)){
args__4736__auto__.push((arguments[i__4731__auto___40281]));

var G__40282 = (i__4731__auto___40281 + (1));
i__4731__auto___40281 = G__40282;
continue;
} else {
}
break;
...
return day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4737__auto__);
});
...
if(cljs.core.contains_QMARK_(cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.loggers.loggers),level)){
} else {
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2((function (){var G__40272 = cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.loggers.loggers);
return (level.cljs$core$IFn$_invoke$arity$1 ? level.cljs$core$IFn$_invoke$arity$1(G__40272) : level.call(null,G__40272));
})(),args);
});
...
/** @this {Function} */
day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.loggers.console.cljs$lang$applyTo = (function (seq40268){
var G__40269 = cljs.core.first(seq40268);
var seq40268__$1 = cljs.core.next(seq40268);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40269,seq40268__$1);
});
...
if(cljs.core.empty_QMARK_(clojure.set.difference.cljs$core$IFn$_invoke$arity$2(cljs.core.set(cljs.core.keys(new_loggers)),cljs.core.set(cljs.core.keys(cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.loggers.loggers)))))){
} else {
throw (new Error(["Assert failed: ","Unknown keys in new-loggers","\n","(empty? (difference (set (keys new-loggers)) (-> (clojure.core/deref loggers) keys set)))"].join('')));
}

return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.loggers.loggers,cljs.core.merge,new_loggers);
});
/**
...
return cljs.core.deref(day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.loggers.loggers);
});

//# sourceMappingURL=day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.loggers.js.map
