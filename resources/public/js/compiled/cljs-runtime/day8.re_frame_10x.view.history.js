...
return (function (){
var G__45038 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","load-epoch","epochs/load-epoch",166872985),id], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__45038) : day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.dispatch.call(null,G__45038));
...
var all_events = cljs.core.deref((function (){var G__45039 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","all-events-by-id","epochs/all-events-by-id",-1225664812)], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__45039) : day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.subscribe.call(null,G__45039));
})());
var current_id = cljs.core.deref((function (){var G__45040 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","current-epoch-id","epochs/current-epoch-id",-482598682)], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__45040) : day8.re_frame_10x.inlined_deps.re_frame.v0v10v9.re_frame.core.subscribe.call(null,G__45040));
})());
...
return (function day8$re_frame_10x$view$history$render_$_iter__45041(s__45042){
return (new cljs.core.LazySeq(null,((function (all_events,current_id){
return (function (){
var s__45042__$1 = s__45042;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__45042__$1);
if(temp__5735__auto__){
var s__45042__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__45042__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__45042__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__45044 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__45043 = (0);
while(true){
if((i__45043 < size__4522__auto__)){
var vec__45046 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__45043);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45046,(0),null);
var event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45046,(1),null);
if(cljs.core.truth_(cljs.core.not_empty(event))){
cljs.core.chunk_append(b__45044,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.history.history_item,event,id,current_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__45063 = (i__45043 + (1));
i__45043 = G__45063;
continue;
} else {
var G__45064 = (i__45043 + (1));
i__45043 = G__45064;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__45044),day8$re_frame_10x$view$history$render_$_iter__45041(cljs.core.chunk_rest(s__45042__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__45044),null);
}
} else {
var vec__45049 = cljs.core.first(s__45042__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45049,(0),null);
var event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45049,(1),null);
if(cljs.core.truth_(cljs.core.not_empty(event))){
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.history.history_item,event,id,current_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$view$history$render_$_iter__45041(cljs.core.rest(s__45042__$2)));
} else {
var G__45069 = cljs.core.rest(s__45042__$2);
s__45042__$1 = G__45069;
continue;
}
}
} else {
...
;
return iter__4523__auto__(all_events);
})()], null)], null);
});
