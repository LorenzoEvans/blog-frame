...
defblog.routes.history = (function (){var dispatch = (function (p1__44348_SHARP_){
var G__44351 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-active-panel","set-active-panel",-965871124),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.Keyword(null,"handler","handler",-195596612).cljs$core$IFn$_invoke$arity$1(p1__44348_SHARP_),new cljs.core.Keyword(null,"slug","slug",2029314850),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__44348_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"route-params","route-params",2111411055),new cljs.core.Keyword(null,"slug","slug",2029314850)], null))], null)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__44351) : re_frame.core.dispatch.call(null,G__44351));
});
var match = ((function (dispatch){
return (function (p1__44349_SHARP_){
return bidi.bidi.match_route(defblog.routes.routes,p1__44349_SHARP_);
});})(dispatch))
;
