...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42554){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42555,G__42556,seq42554__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42578_SHARP_){
return (!((cljs.core.meta(p1__42578_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42592__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42596){var _e__40015__auto__ = e42596;
return false;
}})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
}catch (e42598){var _e__40015__auto__ = e42598;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42608 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42609 = devtools.formatters.state.get_current_state();
devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42609;

try{var map__42610 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42610__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42608;
}});
...
;
var temp__5733__auto___42648 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___42648)){
var managed_print_level_42651 = temp__5733__auto___42648;
var _STAR_print_level_STAR__orig_val__42613_42652 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42614_42653 = managed_print_level_42651;
cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42614_42653;

try{devtools.formatters.state.update_current_state_BANG_(((function (_STAR_print_level_STAR__orig_val__42613_42652,_STAR_print_level_STAR__temp_val__42614_42653,managed_print_level_42651,temp__5733__auto___42648,writer,opts,job_fn){
return (function (p1__42612_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42612_SHARP_,null);
});})(_STAR_print_level_STAR__orig_val__42613_42652,_STAR_print_level_STAR__temp_val__42614_42653,managed_print_level_42651,temp__5733__auto___42648,writer,opts,job_fn))
);

job_fn();
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42613_42652;
}} else {
job_fn();
}
