...
var G__40070 = cljs.core.PersistentArrayMap.EMPTY;
var G__40071 = native_stack_trace;
var G__40072 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__40073 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__40070,G__40071,G__40072,G__40073) : cljs.stacktrace.parse_stacktrace.call(null,G__40070,G__40071,G__40072,G__40073));
});
...
var map__40075 = top_item;
var map__40075__$1 = (((((!((map__40075 == null))))?(((((map__40075.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40075.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__40075):map__40075);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40075__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40075__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40075__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e40074){var _e = e40074;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___40080 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___40080)){
var seen_errors_40081 = temp__5733__auto___40080;
if(cljs.core.truth_(seen_errors_40081.has(self))){
} else {
seen_errors_40081.add(self);

var temp__5735__auto___40082 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___40082)){
var sense_40083 = temp__5735__auto___40082;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_40083)].join('');
} else {
}
}
} else {
