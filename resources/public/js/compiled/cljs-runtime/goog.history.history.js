...
goog.History.prototype.setHash_ = function(token, opt_replace) {
  ...
  if (url != loc.href) {
    if (opt_replace) {
      ...
      goog.dom.safe.setLocationHref(loc, goog.html.uncheckedconversions.safeUrlFromStringKnownToSatisfyTypeContract(goog.string.Const.from("URL taken from location.href."), url));
    }
  }
};
/**
