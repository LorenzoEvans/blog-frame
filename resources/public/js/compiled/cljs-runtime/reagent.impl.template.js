...
var G__51249 = o;
(G__51249[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__51317__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__51317 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__51319__i = 0, G__51319__a = new Array(arguments.length -  0);
while (G__51319__i < G__51319__a.length) {G__51319__a[G__51319__i] = arguments[G__51319__i + 0]; ++G__51319__i;}
  args = new cljs.core.IndexedSeq(G__51319__a,0,null);
} 
return G__51317__delegate.call(this,args);};
G__51317.cljs$lang$maxFixedArity = 0;
G__51317.cljs$lang$applyTo = (function (arglist__51321){
var args = cljs.core.seq(arglist__51321);
return G__51317__delegate(args);
});
G__51317.cljs$core$IFn$_invoke$arity$variadic = G__51317__delegate;
return G__51317;
})()
;
} else {
...
var G__51269 = o;
(G__51269[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__51326__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__51326 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__51327__i = 0, G__51327__a = new Array(arguments.length -  0);
while (G__51327__i < G__51327__a.length) {G__51327__a[G__51327__i] = arguments[G__51327__i + 0]; ++G__51327__i;}
  args = new cljs.core.IndexedSeq(G__51327__a,0,null);
} 
return G__51326__delegate.call(this,args);};
G__51326.cljs$lang$maxFixedArity = 0;
G__51326.cljs$lang$applyTo = (function (arglist__51328){
var args = cljs.core.seq(arglist__51328);
return G__51326__delegate(args);
});
G__51326.cljs$core$IFn$_invoke$arity$variadic = G__51326__delegate;
return G__51326;
})()
;
} else {
...
var G__51274 = props;
var G__51274__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51274,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__51274);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51274__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__51279){
...
var props = map__51280__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51280__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__51280,map__51280__$1,props,class$){
return (function (c){
...
});})(map__51280,map__51280__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__51285){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51286__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__51286,map__51286__$1,on_write){
return (function (){
...
});})(node_value,map__51286,map__51286__$1,on_write))
);
} else {
...
var G__51289 = jsprops;
(G__51289["defaultValue"] = value);

(G__51289["onChange"] = ((function (G__51289,v,value,on_change){
return (function (p1__51288_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__51288_SHARP_);
});})(G__51289,v,value,on_change))
);
...
var vec__51291 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51291,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51291,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51291,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___51375 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___51375 == null)){
} else {
var key_51376 = temp__5739__auto___51375;
(jsprops["key"] = key_51376);
}
...
var temp__5739__auto___51379 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___51379 == null)){
} else {
var key_51380 = temp__5739__auto___51379;
reagent.impl.template.oset(jsprops,"key",key_51380);
}
...
var G__51295 = reagent.impl.template.__GT_NativeWrapper();
(G__51295["name"] = c);
...
var G__51296 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__51296) : reagent.impl.template.as_element.call(null,G__51296));
} else {
...
var len__4730__auto___51384 = arguments.length;
var i__4731__auto___51386 = (0);
while(true){
if((i__4731__auto___51386 < len__4730__auto___51384)){
args__4736__auto__.push((arguments[i__4731__auto___51386]));

var G__51388 = (i__4731__auto___51386 + (1));
i__4731__auto___51386 = G__51388;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq51299){
var G__51300 = cljs.core.first(seq51299);
var seq51299__$1 = cljs.core.next(seq51299);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51300,seq51299__$1);
});
...
break;
default:
var G__51390 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__51390;
continue;
...
var n__4607__auto___51393 = a.length;
var i_51394 = (0);
while(true){
if((i_51394 < n__4607__auto___51393)){
(a[i_51394] = reagent.impl.template.as_element((a[i_51394])));

var G__51395 = (i_51394 + (1));
i_51394 = G__51395;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___51396 = a.length;
var i_51397 = (0);
while(true){
if((i_51397 < n__4607__auto___51396)){
var val_51398 = (a[i_51397]);
if(((cljs.core.vector_QMARK_(val_51398)) && ((reagent.impl.template.key_from_vec(val_51398) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_51397] = reagent.impl.template.as_element(val_51398));

var G__51399 = (i_51397 + (1));
i_51397 = G__51399;
continue;
} else {
}
...
var ctx = ({});
var vec__51303 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51303,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51303,(1),null);
...
var G__51306 = (cljs.core.count(argv) - first_child);
switch (G__51306) {
case (0):
...
case (1):
var G__51307 = comp;
var G__51308 = jsprops;
var G__51309 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__51307,G__51308,G__51309);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__51306){
