...
if((c === "\n")){
var G__42138 = escape_QMARK_;
var G__42139 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__42138;
lines = G__42139;
continue;
} else {
buf.append(c);

var G__42140 = (((!(escape_QMARK_))) && ((c === "\\")));
var G__42141 = lines;
escape_QMARK_ = G__42140;
lines = G__42141;
continue;
...
var G__42135 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__42135) : rewrite_clj.node.string_node.call(null,G__42135));
});
...
var G__42136 = cljs.core.re_pattern(regex);
var G__42137 = ["#\"",cljs.core.str.cljs$core$IFn$_invoke$arity$1(regex),"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__42136,G__42137) : rewrite_clj.node.token_node.call(null,G__42136,G__42137));
});
