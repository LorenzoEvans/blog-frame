...
return rewrite_clj.reader.read_until(reader,(function (p1__42144_SHARP_){
return ((cljs.core.not((allowed_QMARK_.cljs$core$IFn$_invoke$arity$1 ? allowed_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__42144_SHARP_) : allowed_QMARK_.call(null,p1__42144_SHARP_)))) && (rewrite_clj.reader.whitespace_or_boundary_QMARK_(p1__42144_SHARP_)));
}));
});
...
var G__42145 = (rewrite_clj.reader.read_string.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.reader.read_string.cljs$core$IFn$_invoke$arity$1(s) : rewrite_clj.reader.read_string.call(null,s));
var G__42146 = s;
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__42145,G__42146) : rewrite_clj.node.token_node.call(null,G__42145,G__42146));
}
});
/**
