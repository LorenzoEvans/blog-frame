...
var G__42359 = (i__4731__auto___42354 + (1));
i__4731__auto___42354 = G__42359;
continue;
} else {
}
break;
...
rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__42298){
var vec__42299 = p__42298;
var additional = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42299,(0),null);
if(cljs.core.truth_(additional)){
return ((function (vec__42299,additional){
...
;})(vec__42299,additional))
} else {
return ((function (vec__42299,additional){
return (function (p1__42295_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__42295_SHARP_),t);
});
;})(vec__42299,additional))
}
});
...
/** @this {Function} */
rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq42296){
var G__42297 = cljs.core.first(seq42296);
var seq42296__$1 = cljs.core.next(seq42296);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42297,seq42296__$1);
});

rewrite_clj.zip.findz.in_range_QMARK_ = (function rewrite_clj$zip$findz$in_range_QMARK_(p__42302,p__42303){
var map__42304 = p__42302;
...
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42304__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42304__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var end_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42304__$1,new cljs.core.Keyword(null,"end-row","end-row",-545103581));
var end_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42304__$1,new cljs.core.Keyword(null,"end-col","end-col",-724155879));
var map__42305 = p__42303;
var map__42305__$1 = (((((!((map__42305 == null))))?(((((map__42305.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42305.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__42305):map__42305);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42305__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var c = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42305__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
...
return cljs.core.last(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__42310_SHARP_){
var and__4120__auto__ = (p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__42310_SHARP_) : p_QMARK_.call(null,p1__42310_SHARP_));
if(cljs.core.truth_(and__4120__auto__)){
return rewrite_clj.zip.findz.in_range_QMARK_(cljs.core.meta(clojure.zip.node(p1__42310_SHARP_)),pos);
} else {
return and__4120__auto__;
}
...
var G__42319 = zloc;
var G__42319__$1 = (((G__42319 == null))?null:(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__42319) : f.call(null,G__42319)));
if((G__42319__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(G__42319__$1,f,p_QMARK_);
}
});
...
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(zloc,f,(function (p1__42320_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__42320_SHARP_),t);
}));
});
...
return rewrite_clj.zip.findz.find_last_by_pos.cljs$core$IFn$_invoke$arity$3(zloc,pos,(function (p1__42331_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__42331_SHARP_),t);
}));
});
/**
...
var p_QMARK_ = ((cljs.core.set_QMARK_(v))?cljs.core.comp.cljs$core$IFn$_invoke$arity$2(v,rewrite_clj.zip.base.sexpr):(function (p1__42347_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.sexpr(p1__42347_SHARP_),v);
}));
