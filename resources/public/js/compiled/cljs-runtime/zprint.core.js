...
var vec__43762 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__43765 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43765,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43765,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43762,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43762,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__43768){
var vec__43769 = p__43768;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43769,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43769,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43772,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43772,(1),null);
...
var vec__43776 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43776,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43776,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43776,(2),null);
var vec__43779 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43779,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43779,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43779,(2),null);
...
var G__43782 = special_option;
var G__43782__$1 = (((G__43782 instanceof cljs.core.Keyword))?G__43782.fqn:null);
switch (G__43782__$1) {
case "explain":
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__43783){
var vec__43784 = p__43783;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43784,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43784,(1),null);
...
var len__4730__auto___43877 = arguments.length;
var i__4731__auto___43878 = (0);
while(true){
if((i__4731__auto___43878 < len__4730__auto___43877)){
args__4736__auto__.push((arguments[i__4731__auto___43878]));

var G__43879 = (i__4731__auto___43878 + (1));
i__4731__auto___43878 = G__43879;
continue;
} else {
}
break;
...
return zprint.core.zprint_str_internal.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__4737__auto__);
});

zprint.core.zprint_str_internal.cljs$core$IFn$_invoke$arity$variadic = (function (internal_options,coll,rest){
var vec__43790 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43790,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43790,(1),null);
...
var G__43793 = zprint.core.parse_string_all_options(rest_options);
var G__43794 = zprint.core.zprint_str_internal;
var G__43795 = ":parse-string-all? call";
var G__43796 = (function (){var G__43797 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__43797) : zprint.zutil.edn_STAR_.call(null,G__43797));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__43793,G__43794,G__43795,G__43796) : zprint.core.process_multiple_forms.call(null,G__43793,G__43794,G__43795,G__43796));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__43798 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43798,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43798,(1),null);
...
/** @this {Function} */
zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq43787){
var G__43788 = cljs.core.first(seq43787);
var seq43787__$1 = cljs.core.next(seq43787);
var G__43789 = cljs.core.first(seq43787__$1);
var seq43787__$2 = cljs.core.next(seq43787__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43788,G__43789,seq43787__$2);
});
...
var args__4736__auto__ = [];
var len__4730__auto___43881 = arguments.length;
var i__4731__auto___43882 = (0);
while(true){
if((i__4731__auto___43882 < len__4730__auto___43881)){
args__4736__auto__.push((arguments[i__4731__auto___43882]));

var G__43883 = (i__4731__auto___43882 + (1));
i__4731__auto___43882 = G__43883;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.zprint_str.cljs$lang$applyTo = (function (seq43803){
var G__43804 = cljs.core.first(seq43803);
var seq43803__$1 = cljs.core.next(seq43803);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43804,seq43803__$1);
});
...
var args__4736__auto__ = [];
var len__4730__auto___43884 = arguments.length;
var i__4731__auto___43885 = (0);
while(true){
if((i__4731__auto___43885 < len__4730__auto___43884)){
...
/** @this {Function} */
zprint.core.czprint_str.cljs$lang$applyTo = (function (seq43805){
var G__43806 = cljs.core.first(seq43805);
var seq43805__$1 = cljs.core.next(seq43805);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43806,seq43805__$1);
});
...
/** @this {Function} */
zprint.core.zprint.cljs$lang$applyTo = (function (seq43814){
var G__43815 = cljs.core.first(seq43814);
var seq43814__$1 = cljs.core.next(seq43814);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43815,seq43814__$1);
});
...
var G__43907 = (i__4731__auto___43903 + (1));
i__4731__auto___43903 = G__43907;
continue;
} else {
}
break;
...
/** @this {Function} */
zprint.core.czprint.cljs$lang$applyTo = (function (seq43820){
var G__43821 = cljs.core.first(seq43820);
var seq43820__$1 = cljs.core.next(seq43820);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__43821,seq43820__$1);
});
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__43823,form){
var vec__43824 = p__43823;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43824,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43824,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43824,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43824,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__43827 = (cljs.core.truth_((function (){var and__4120__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4120__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43827,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43827,(1),null);
...
var output_str = ((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"off","off",606440789),new cljs.core.Keyword(null,"format","format",-1306924766).cljs$core$IFn$_invoke$arity$1(decision_options))) || ((((!((function (){var or__4131__auto__ = comment_QMARK_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [((local_QMARK_)?zprint.config.merge_deep.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([next_options__$1,new_options], 0)):(((function (){var or__4131__auto__ = comment_QMARK_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
return whitespace_form_QMARK_;
...
var forms = (function (){var G__43838 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__43838) : zprint.zutil.edn_STAR_.call(null,G__43838));
})();
