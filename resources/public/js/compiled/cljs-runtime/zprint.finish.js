...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__41461_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__41461_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__41461_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__41462){
var vec__41463 = p__41462;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41463,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41463,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__41466,s,color,element,idx){
var map__41467 = p__41466;
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41467__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41467__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41467__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__41471 = (function (){var or__4131__auto__ = color;
...
var fexpr__41470 = (function (){var G__41472 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__41472) : style_map.call(null,G__41472));
})();
return (fexpr__41470.cljs$core$IFn$_invoke$arity$1 ? fexpr__41470.cljs$core$IFn$_invoke$arity$1(G__41471) : fexpr__41470.call(null,G__41471));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__41473){
var vec__41474 = p__41473;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41474,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41474,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41474,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__41477){
var vec__41478 = p__41477;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41478,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41478,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41478,(2),null);
...
var G__41623 = cljs.core.next(ssv);
var G__41624 = (this_ssv == null);
var G__41625 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__41626 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__41623;
doing_nil_QMARK_ = G__41624;
last_elide = G__41625;
out = G__41626;
continue;
}
...
var vec__41491 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41491,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41491,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41491,(2),null);
...
var G__41637 = cljs.core.next(remaining_cvec);
var G__41638 = new_idx;
var G__41639 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__41637;
idx = G__41638;
out = G__41639;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__41498,cursor_vec){
var vec__41500 = p__41498;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41500,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41500,(1),null);
var focus_vec = vec__41500;
...
var vec__41504 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41504,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41504,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__41513){
var vec__41514 = p__41513;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41514,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41514,(1),null);
if((color == null)){
return s;
} else {
...
zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__41546,existing_count){
var vec__41547 = p__41546;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41547,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41547,(1),null);
...
return cljs.core.filterv(((function (s__$1,len,cursor__$1,vec__41547,s,cursor){
return (function (p1__41537_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__41537_SHARP_))));
});})(s__$1,len,cursor__$1,vec__41547,s,cursor))
...
var vec__41561 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41561,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41561,(1),null);
var cvec_element = vec__41561;
if((cvec_element == null)){
var G__41655 = cljs.core.next(cvec_nl);
var G__41656 = (idx + (1));
var G__41657 = start;
var G__41658 = out;
cvec_nl = G__41655;
...
var G__41665 = cljs.core.next(cvec_nl);
var G__41666 = (idx + (1));
var G__41667 = idx;
var G__41668 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__41665;
idx = G__41666;
start = G__41667;
out = G__41668;
...
var G__41669 = cljs.core.next(cvec_nl);
var G__41670 = (idx + (1));
var G__41671 = (idx + (1));
var G__41672 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__41669;
idx = G__41670;
start = G__41671;
out = G__41672;
...
var G__41673 = cljs.core.next(cvec_nl);
var G__41674 = (idx + (1));
var G__41675 = idx;
var G__41676 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__41673;
idx = G__41674;
start = G__41675;
out = G__41676;
...
var G__41677 = cljs.core.next(cvec_nl);
var G__41678 = (idx + (1));
var G__41679 = start;
var G__41680 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__41677;
idx = G__41678;
start = G__41679;
out = G__41680;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__41568_SHARP_,p2__41567_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__41567_SHARP_)){
return cljs.core.reduced(p1__41568_SHARP_);
} else {
return (p1__41568_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__41569,p__41570){
var vec__41572 = p__41569;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41572,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41572,(1),null);
var vec__41575 = p__41570;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41575,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41575,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__41580,cvec,focus_vec){
var map__41581 = p__41580;
var map__41581__$1 = (((((!((map__41581 == null))))?(((((map__41581.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41581.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__41581):map__41581);
var options = map__41581__$1;
var map__41582 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41581__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41582__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41582__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41582__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__41581,map__41581__$1,options,map__41582,map__41582__$1,focus,lines,paths){
return (function (p1__41579_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__41579_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
});})(lines_to_cvec,surround,cvec_ranges,cvec_ranges__$1,path_vecs,map__41581,map__41581__$1,options,map__41582,map__41582__$1,focus,lines,paths))
,path_vecs);
